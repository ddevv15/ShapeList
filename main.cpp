...
int main()
{
	...
	cout << endl
		 << endl
		 << "Adding Shape to the front" << endl;
	...
	cout << endl
		 << endl
		 << "Adding Circle to the front" << endl;
	s = new Circle(2, 4, 3);
	myCanvas.push_front(s);
	cout << "List size: " << myCanvas.size() << endl;
	myCanvas.draw();
	...
	cout << endl
		 << endl
		 << "Adding Rectangle to the back" << endl;
	s = new Rect(0, 10);
	...
	cout << endl
		 << endl
		 << "Adding Right Triangle to the front" << endl;
	...
	cout << endl
		 << endl
		 << "Inserting Shape after index 1" << endl;
	cout << "Original:" << endl;
	myCanvas.draw();
